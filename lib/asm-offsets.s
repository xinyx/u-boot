...
# -MD lib/.asm-offsets.s.d lib/asm-offsets.c -mregparm=3
...
# -ffreestanding -fno-stack-protector -fstack-usage -fno-strict-aliasing
# -fomit-frame-pointer -fno-toplevel-reorder -fno-dwarf2-cfi-asm
# -ffunction-sections -fvisibility=hidden -fverbose-asm
...
->GD_SIZE $156 sizeof(struct global_data)	#
# 0 "" 2
	.loc 1 30 0
